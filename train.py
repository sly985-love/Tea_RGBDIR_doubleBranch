...
# python train.py  --weights best.pt --cfg models/transformer/yolov5s_fusion_add_apple.yaml --data data/multispectral/apple.yaml  --device 0;
#
if __name__ == '__main__':
    ...
    #r'D:\帅璐宇\RGBD_TEA\yolov5'
    # parser.add_argument('--project', default='runs/train', help='save to project/name')
    parser.add_argument('--project', default=r'D:\帅璐宇\RGBD_TEA\multispectral_2', help='save to project/name')
